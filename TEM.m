...
%Delete columns corresponding to n_eff < surrounding n
n_surround = max([n_left, n_right, n_top, n_bottom]);
e_vects(:, find(n_eff < n_surround)) = [];
e_vals(find(n_eff < n_surround)) = [];
n_eff(n_eff < n_surround) = [];
